        ...
        <div class="content">
            <div class="main-container">
                ...
                <form class="main-container-form" method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn2" name="hello3" type="submit">Next</button>
                    
                </form>
                <form class="main-container-form"  method="post"><button class="btn1" name="hello33" type="submit">Skip</button></form>
            </div>
        </div>
    </main>
...
<?php if(($_SERVER["REQUEST_METHOD"] == "POST") && (isset($_POST['hello33']))) {
